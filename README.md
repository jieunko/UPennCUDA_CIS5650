...
\[G(\omega_i, \omega_o) = \frac{1}{1 + \Lambda(\omega_o) + \Lambda(\omega_i)}\] \[\Lambda(\theta) = \frac{-1 + \sqrt{1 + \tan^2\theta}}{2}\]\[tan^2\theta = \frac{\alpha^2}{\cos^2\theta}, where\ \alpha\ is\ a\ roughness\ parameter \]
